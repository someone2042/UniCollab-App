...
<body class="h-screen bg-back background">
    ...
    <div class="center">
        ...
        <div class="content1 overflow-auto h-calc-screen2">
            <div id="myDiv" class="backimage h-full w-full">
            </div>
            <style>
                .parent-div {
                    width: 100%;
                    ...
                    @foreach ($invitations as $invitation)
                        ...
                        <div class="child-div">
                            <div class=" w-1/5 flex items-center justify-center h-full ">
                                <div class="h-24 w-24 ">
                                    <img src="{{ asset($profile) }}" class="w-full h-full object-cover rounded-full"
                                        alt="">
                            ...
                            <div class="w-2/5 flex justify-end">
                                <form action="/group/{{ $mainGroup->id }}/invitations/{{ $invitation->id }}"
                                    method="POST">
                                    @csrf
                                    <button class="bg-blue-600 w-24 rounded-md mr-2 text-lg p-2 text-white hover:scale-95 "
                                        value="Accept" name="res">Accept</button>
                                    <button
                                        class="bg-gray-100 w-24 rounded-md mr-4 text-lg p-2 text-blue-600 border border-blue-600 hover:scale-95 "
                                        value="Refuse" name="res">Refuse</button>
                                </form>
                            </div>
                        </div>
                    @endforeach
                @else
                    <p class="text-6xl m-auto pt-56  select-none text-center font-semibold text-gray-800 opacity-50">
                        No invitations</p>
                @endunless
            </div>
        </div>
