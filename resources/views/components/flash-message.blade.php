...
<div x-data="{ show: true }" x-init="setTimeout(()=>show=false,3000)" x-show="show" style="z-index: 999" class="fixed top-5 left-1/2 transform shadow-xl z-50 p-3 rounded-md -translate-x-1/2 bg-red-200 text-red-800 border-red-700 border-2 px-42 py-3">
