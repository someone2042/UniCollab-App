            ...
            <div class="header1 h-16 overflow-hidden">
                ...
                <div class="w-1/4 h-full grid items-center hoverstyle">
                    <a href="/group/{{ $mainGroup->id }}/task" class="relative">
                        ...
                        <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none"
                            class="sm:hidden m-auto" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M9 22H15C20 22 22 20 22 15V9C22 4 20 2 15 2H9C4 2 2 4 2 9V15C2 20 4 22 9 22Z"
                                stroke="#1967D2" stroke-width="1.5" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                        @if ($taskcount != 0)
                            <span
                ...
                <div class="w-1/4 h-full grid items-center hoverstyle ">
                    <a href="/group/{{ $mainGroup->id }}/documents">
                        ...
                        <svg width="40px" height="40px" viewBox="0 0 24 24" fill="none"
                            class="sm:hidden m-auto" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.4299 14.55H9.42993" stroke="#1967D2" stroke-width="1.5"
                    ...
                    <div class="w-full h-1/12">
                        <form id="form" class="flex h-full w-full justify-evenly pb-1 items-center">
                            ...
                            <button class="">
                                ...
                                <svg fill="#1967D2" width="40px" height="40px" viewBox="0 0 32 32"
                ...
                @foreach ($members as $member)
                    ...
                    @else
                        @if ($member->id == $user->id)
                            <div class="w-full border-b border-blue2 border-r-blue1 pl-1 md:pl-2 bg-blue2 h-14 flex items-center"
                                id="m{{ $member->id }}">
                            @else
