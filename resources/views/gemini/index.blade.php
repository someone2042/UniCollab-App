      ...
      data:    {
        ...
        messageHtml=    
            `<div class=" m-1 w-full h-fit flex message">
                <div class="w-8 h-8 mr-1 rounded-full bg-gray-500">
                ...
                <div class="grid max-w-4/5">
                    ...
                    <div class="bg-slate-600 w-full rounded-b-xl rounded-r-xl">
                        <div class="text-left text-sm text-gray-200 px-2 font-mon">`+res.responseData.candidates[0].content.parts[0].text+`</div>
                        <p class="text-xs text-end mr-2 text-white"></p>
                    </div>
                </div>
            </div>`;
