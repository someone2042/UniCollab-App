                            ...
                            <a href="/group/{{$mainGroup->id}}/task/{{$task->id}}">
                                <div class="flex justify-between h-9 pt-2 text-gray-600">
                                    ...
                                    <div class="w-2/12 text-sm flex justify-end items-center">
                                        @if (auth()->user()->id==$mainGroup->leader_id)
                                        <form method="POST" action="/group/{{$mainGroup->id}}/task/{{$task->id}}">
                                            @method('DELETE')
                                            @csrf
                                            <button type="submit">
                                                <svg width="15px" height="15px" viewBox="-3 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns">
